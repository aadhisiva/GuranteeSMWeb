...
export const ASSIGNMENT_DASHBOARD = "/AssignMentDashboard";
export const ASSIGNED_DATA = "/AssignedData";
export const ASSIGN_TO_MASTER = "/AssignToMaster";

export const ASSIGN_TO_DISTRICT = "/AssignToDistrict";
